export const typeSelectorArr = [
  ...
  // 1) Первичное обращение по услуге
  {
    ...
    field: [
      { id: 1, title: 'Назовите задачу так, чтобы сразу была понятна суть', placeholder: 'Например: Запустить продвижение новой услуги Умный шлагбаум', typeField: 'text', type: 'text', name: 'title' },
      { id: 2, title: 'Название продукта / услуги', placeholder: 'например: «Умный шлагбаум», «Free Wi-Fi в городе»', typeField: 'text', type: 'text', name: 'description' },
      ...
      { id: 19, title: 'Если сайт требует изменений, распишите подробнее, что нужно поменять.', placeholder: 'Если сайт требует изменений, распишите подробнее, что нужно поменять.', typeField: 'area', type: 'area', name: 'site_changes' },
  ...
  // 2) ТЗ на создание сайта/страницы
  {
    ...
    field: [
      { id: 1, title: 'Назовите задачу так, чтобы сразу была понятна суть', placeholder: 'Например: Создания посадочной страницы на услугу Умный шлагбаум', typeField: 'text', type: 'text', name: 'title' },
      { id: 2, title: 'Название продукта / услуги', placeholder: 'Например: «Умный шлагбаум», «Free Wi-Fi в городе»', typeField: 'text', type: 'text', name: 'description' },
      ...
      { id: 10, title: 'Пожелания по дизайну сайта / лендинга / страницы.', placeholder: 'Пожелания по дизайну/странице', typeField: 'text', type: 'text', name: 'wishes' },
      { id: 11, title: 'Есть ли макеты, которые можно взять за основу дизайна', placeholder: 'Коммерческое предложение, афиша, брошюра и т.п.', typeField: 'area', type: 'area', name: 'content' },
      { id: 12, title: 'Есть ли референсы (сайты / лендинги / страницы), на которые стоит ориентироваться по дизайну или содержанию?', placeholder: 'Ссылки на примеры', typeField: 'area', type: 'area', name: 'refs' },
      { id: 13, title: 'В чём заключаются преимущества и выгоды продукта? (по сравнению с конкурентом, альтернативным решением или отсутствием продукта).', placeholder: 'Вставьте текст', typeField: 'area', type: 'area', name: 'advantages' },
      { id: 14, title: 'Нужно ли объяснять, как работает продукт? Если да, опишите это подробно.', placeholder: 'Вставьте текст', typeField: 'area', type: 'area', name: 'work' },

      { id: 15, title: 'Какие есть варианты приобретения продукта (разные тарифы, оборудование, скидки, акции, опции и т.п.)?', placeholder: 'Вставьте текст', typeField: 'area', type: 'area', name: 'price' },
      { id: 16, title: 'Какая дополнительная информация должна присутствовать на сайте / лендинге / странице (отзывы, карты, схемы, ссылки, контакты, описания и т.д.)?', placeholder: 'Вставьте текст', typeField: 'area', type: 'area', name: 'details' },

      { id: 17, title: 'Должны ли мобильная и десктопная версии совпадать по содержанию? Есть ли контент или функционал, который будет доступен только в одной из версий?', placeholder: 'Вставьте текст', typeField: 'area', type: 'area', name: 'site_content' },
  ...
  // 3) ТЗ на внесение изменений на сайты
  {
    ...
    field: [
      { id: 1, title: 'Назовите задачу так, чтобы сразу была понятна суть', placeholder: 'Например: Добавить новый блок тарифов на страницу услуги Умный шлагбаум', typeField: 'text', type: 'text', name: 'title'},
      {
        id: 2,
  ...
  // 4) ТЗ на запуск рекламы
  {
    ...
    field: [
      { id: 1, title: 'Назовите задачу так, чтобы сразу была понятна суть.', placeholder: 'Например: Запустить рекламу в Яндексе (услуга интернет, город Уфа)', typeField: 'text', type: 'text', name: 'title' },
      {
        id: 2,
        ...
        options: [
          ...
          { id: 7, label: 'Google Ads', value: 'google_ads', icon: '' },
          { id: 8, label: 'Реклама в партнерских базах (email / sms / push)', value: 'partner_bases', icon: '' },
          { id: 9, label: 'Другое', value: 'other', icon: '' }
        ]
      },
      {
        id: 3,
        ...
        options: [
          ...
          { id: 6, label: 'Другое', value: 'other', icon: '' }
        ]
      },
      ...
      { id: 9, title: 'Есть ли акции, скидки или подарки?', placeholder: 'Например: “Скидка 15% при заказе до 1 мая”, “Бесплатное подключение”', typeField: 'area', type: 'area', name: 'discounts' },
      {
        ...
        name: 'sales_path',
        options: [
          { id: 1, label: 'Отдел телемаркетинга (ОТМ)', value: 'otm', icon: '' },
      ...
      { id: 12, title: 'Ссылки на материалы, если есть (без них запуск рекламы будет позже)', placeholder: 'Картинки, макеты, презентации, фото, исходники, тексты объявлений и т.п.', typeField: 'file', type: 'file', name: 'banner_file' },
      ...
      { id: 18, title: 'Дата запуска', placeholder: 'Желаемая дата', typeField: 'date', type: 'date', name: 'deadline' }
    ]
  },
...

  {
    ...
    field: [
      { id: 1, title: 'Назовите задачу так, чтобы сразу была понятна суть.', placeholder: 'Например: Выложить пост в группу ВК Уфанет про заход в новый поселок', typeField: 'text', type: 'text', name: 'title' },
      ...
      { id: 6, title: 'Прикрепи ссылку на материалы, если они есть', placeholder: 'Тексты, изображения, презентации, ссылки', typeField: 'file', type: 'file', name: 'material_file' },
  ...
  // 6) ТЗ на написание статей
  {
    ...
    field: [
      { id: 1, title: 'Опишите задачу кратко (это будет названием задачи)', placeholder: 'Например: Написание статьи для газеты “Вестник” в Стерлитамаке про Умный домофон.', typeField: 'text', type: 'text', name: 'title' },
      { id: 2, title: 'Что необходимо сделать?', placeholder: 'Опишите задачу своими словами', typeField: 'area', type: 'area', name: 'description' },
      ...
      { id: 9, title: 'Ссылки и материалы', placeholder: 'Соберите все тексты и материалы, на которые можно ориентироваться, в Google Docs (https://docs.google.com/) и прикрепите сюда ссылку.', typeField: 'text', type: 'text', name: 'link_text' },
      { id: 10, title: 'Референсы', placeholder: 'Приложите ссылки на удачные публикации у других компаний.', typeField: 'text', type: 'text', name: 'reference_text' },
  ...
  // 7) ТЗ на редактуру
  {
    ...
    field: [
      { id: 1, title: 'Назовите задачу так, чтобы сразу была понятна суть', placeholder: 'Например: Редактура статьи для газеты “Вестник” в Стерлитамаке про Умный домофон.', typeField: 'text', type: 'text', name: 'title' },
      ...
      { id: 7, title: 'Цель размещения', placeholder: 'Например: повысить доверие к бренду, рассказать о продукте, улучшить SEO', typeField: 'area', type: 'area', name: 'goal' },
      ...
      { id: 9, title: 'Пожелания', placeholder: 'Важно ли при внесении правок сохранить количество символов и другие пожелания.', typeField: 'area', type: 'area', name: 'preferences' },
      { id: 10, title: 'Ссылки', placeholder: 'Создайте гугл-документ https://docs.google.com/ с текстом, который нужно отредактировать, и  укажите здесь ссылку.', typeField: 'text', type: 'text', name: 'links' },
      { id: 11, title: 'Желаемая дата реализации', placeholder: 'Дата выполнения', typeField: 'date', type: 'date', name: 'deadline' }
    ]
  },
  ...
  // 8) ТЗ на пуши в приложении
  {
    ...
    field: [
      { id: 1, title: 'Назовите задачу так, чтобы сразу была понятна суть', placeholder: 'Например: Отправить PUSH в приложение Уфанет по городу Казань, услуга Умный Домофон', typeField: 'text', type: 'text', name: 'title' },
      ...
      { id: 4, title: 'Прикрепите файл с выгрузкой абонентов Если у вас нет готового файла - пропустите этот вопрос', placeholder: 'Если у вас нет готового файла - поставьте прочерк”', typeField: 'file', type: 'file', name: 'abonents_file' },
  ...
  // 9) Сторис в приложении Уфанет
  {
    ...
    field: [
      { id: 1, title: 'Назовите задачу так, чтобы сразу была понятна суть', placeholder: 'Например: Разместить сторис в приложении Уфанет в Стерлитамаке про Умный домофон.', typeField: 'text', type: 'text', name: 'title' },
      { id: 2, title: 'Что необходимо сделать?', placeholder: 'Кратко о задаче', typeField: 'area', type: 'area', name: 'description' },
      ...
      { id: 11, title: 'Прикрепите изображения сторис. Если на сторис предполагается кнопка, фон должен быть контрастный оранжевому, так как кнопка оранжевого цвета.', placeholder: 'Прикрепите изображение, если оно готово - Вес файла: не более 2 МБ - Размер: 1080х1920px', typeField: 'file', type: 'file', name: 'storis_file' },
      { id: 12, title: 'Прикрепите миниатюру-баннер', placeholder: 'Прикрепите изображение, если оно готово - Вес файла: не более 1 МБ - Размер: 256х256px', typeField: 'file', type: 'file', name: 'miniature_file' },
  ...
  // 10) ТЗ на опросы
  {
    ...
    field: [
      { id: 1, title: 'Назовите задачу так, чтобы сразу была понятна суть', placeholder: 'Например: Запустить опрос на абонентов Уфанет в городе Уфа. Маркетинговое исследование.', typeField: 'text', type: 'text', name: 'title' },
      { id: 2, title: 'Что необходимо сделать?', placeholder: 'Кратко о задаче', typeField: 'area', type: 'area', name: 'description' },
      { id: 3, title: 'Цель опроса', placeholder: 'Исследование, обратная связь, потребности, NPS и т.д.', typeField: 'area', type: 'area', name: 'goal' },
      { id: 4, title: 'Целевая аудитория. Чьи ответы вы хотите видеть в результатах?', placeholder: 'Возраст, пол, город, интересы, профессии и т.п.', typeField: 'area', type: 'area', name: 'target_audience' },
      {
        id: 5,
      ...
      { id: 7, title: 'Схема опроса', placeholder: 'Прикрепите ссылку на схему опроса или список вопросов', typeField: 'file', type: 'file', name: 'schema_file' },
