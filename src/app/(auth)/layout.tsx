...
import FooterAuth from '@/components/element/FooterAuth/FooterAuth'
    ...
    <Container className='vw-100 d-flex flex-column justify-content-center mt-5 mb-5'>
      ...
      <Row className='d-flex justify-content-center mt-4'>
        <Col md={8} className='d-flex justify-content-center mb-1' style={{padding: '0'}}>
          <Qrcode
              title={`Подпишитесь на бота в Telegram, только после этого регистрируйся на сайте. Это важно для подтверждения регистрации`}
